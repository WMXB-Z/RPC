...
PROTOBUF_NAMESPACE_OPEN
template<> ::sylar::tinyrpc::RpcHeader* Arena::CreateMaybeMessage<::sylar::tinyrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace sylar {
namespace tinyrpc {
...
class RpcHeader PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:sylar.tinyrpc.RpcHeader) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "sylar.tinyrpc.RpcHeader";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:sylar.tinyrpc.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:sylar.tinyrpc.RpcHeader.service_name)
  return _internal_service_name();
}
inline void RpcHeader::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:sylar.tinyrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:sylar.tinyrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:sylar.tinyrpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value) {
  ...
  service_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:sylar.tinyrpc.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const void* value,
  ...
  // @@protoc_insertion_point(field_set_pointer:sylar.tinyrpc.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:sylar.tinyrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  service_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:sylar.tinyrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::unsafe_arena_release_service_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sylar.tinyrpc.RpcHeader.service_name)
...
inline void RpcHeader::unsafe_arena_set_allocated_service_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sylar.tinyrpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:sylar.tinyrpc.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:sylar.tinyrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:sylar.tinyrpc.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:sylar.tinyrpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:sylar.tinyrpc.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const void* value,
  ...
  method_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:sylar.tinyrpc.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:sylar.tinyrpc.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  method_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:sylar.tinyrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::unsafe_arena_release_method_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sylar.tinyrpc.RpcHeader.method_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void RpcHeader::unsafe_arena_set_allocated_method_name(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sylar.tinyrpc.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:sylar.tinyrpc.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:sylar.tinyrpc.RpcHeader.args_size)
}
